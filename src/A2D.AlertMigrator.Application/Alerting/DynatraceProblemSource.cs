...
public sealed record DynatraceProblemSource(
    string TenantKey,
    string Environment,
    string TenantAlias,
    Uri BaseAddress,
    ...
    int ResultLimit)
{
    public void EnsureValid()
    {
        ...
        {
            throw new ArgumentException("Problemas do Grail exigem Platform Token ou OAuth no modo Bearer.");
        }
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(ResultLimit), "O limite deve ficar entre 1 e 5.000 problemas.");
        }
    }
}
